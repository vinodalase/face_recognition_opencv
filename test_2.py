...
if __name__ == "__main__":
	# print("Training KNN classifier...")
	  #classifier = train("/home/cglvs/Desktop/valase/SVM_folder/train_dir", model_save_path="trained_knn_model.clf", n_neighbors=4)
	# print("Training complete!")'http://192.168.8.133:8081/stream.mpg'
	...
	while True:
		...
		for name, (top, right, bottom, left) in predictions:
			...
			if name == "unknown":
				#print("The person is not authenticated",name)
				...
				# Draw a label with a name below the face
				#print("Person is authenticated",name)
				cv2.rectangle(frame, (left, bottom - 35), (right, bottom), (0, 0, 255), cv2.FILLED)
				font = cv2.FONT_HERSHEY_DUPLEX
				cv2.putText(frame, 'known', (left + 6, bottom - 6), font, 1.0, (255, 255, 255), 1)
				# Display the resulting image
				cv2.imshow('Video', frame)
